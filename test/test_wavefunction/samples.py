...
refs: dict[str, Refs] = {
    "H": {
        ...
        "e_fermi": torch.tensor([-0.24062270215091458, 0.0000000000000000]),
        "entropy": torch.tensor([0.0000000000000000]),
        "emo": torch.tensor(
            [
                [-0.40142947446183008, -7.9815929839999106e-002],
                [+0.00000000000000000, +0.0000000000000000],
            ]
        ),
        "focc": torch.tensor(
            [
                [1.0000000000000000e00, 0.0000000000000000e00],
    ...
    "H2": {
        ...
        "e_fermi": torch.tensor(
            [-0.3110880516469479, -0.3110880516469479],
        ),
        "entropy": torch.tensor([0.0000000000000000]),
        "emo": torch.tensor(
            [
    ...
    "He": {
        ...
        "density": torch.tensor([0.0000000000000000]),
        "overlap": torch.tensor([0.0000000000000000]),
        "e_fermi": torch.tensor([-0.81293234281729443, -0.81293234281729443]),
        "entropy": torch.tensor([0.0000000000000000]),
        "emo": torch.tensor(
            [[-0.81293234281729443], [-0.81293234281729443]],
        ),
        "focc": torch.tensor(
    ...
    "LiH": {
        ...
        "e_fermi": torch.tensor([-0.3454470410943031, -0.3454470410943031]),
        "entropy": torch.tensor([0.0000000000000000]),
        "focc": torch.tensor(
            [
                [
    ...
    "SiH4": {
        ...
        "e_fermi": torch.tensor([-0.3210534304380417, -0.3210534304380417]),
        "entropy": torch.tensor([0.0000000000000000]),
        "focc": torch.tensor(
            [
                [
    ...
    "S2": {
        ...
        "e_fermi": torch.tensor([-0.38648638884647568, -0.38648638884647568]),
