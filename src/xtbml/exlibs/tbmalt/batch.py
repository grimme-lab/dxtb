...
def index(inp: Tensor, idx: Tensor) -> Tensor:
    ...
    >>> inp = torch.tensor([
    ...     [
    ...         0.4800, 0.4701, 0.3405, 0.4701, 0.4701, 0.5197, 0.7882, 0.4761,
    ...         0.4800, 0.4701, 0.6440, 0.4701, 0.4701, 0.5833, 0.7882, 0.3542
    ...     ],
    ...     [
    ...         0.4800, 0.4701, 0.3405, 0.4701, 0.4701, 0.5197, 0.7882, 0.4761,
    ...         0.4800, 0.4701, 0.6440, 0.4701, 0.4701, 0.5833, 0.7882, 0.3542
    ...
    ...     ]
    ... ])
    >>> print(batch.index(inp, src))
    tensor([[0.4800, 0.4800, 0.4701, 0.4701, 0.3405, 0.3405, 0.4701, 0.4701,
             0.4701, 0.4701, 0.5197, 0.5197, 0.5197, 0.7882, 0.7882, 0.4761,
             0.4761, 0.4800, 0.4800, 0.4701, 0.4701, 0.6440, 0.6440, 0.6440,
             0.4701, 0.4701, 0.4701, 0.4701, 0.5833, 0.5833, 0.7882, 0.7882,
             0.3542, 0.3542],
    ...
    ...         [-4.5183, -6.7240, -2.9003],
    ...         [-1.2566, -2.3939, -4.5877],
    ...         [-0.1486,  4.4007,  1.3572],
    ...         [-0.9166, -2.2268,  0.7112],
    ...         [ 1.8328,  5.3606,  3.2210],
    ...         [ 0.6652,  6.3098,  4.6271],
    ...         [ 3.6870,  2.7996,  4.2134],
    ...         [ 1.6937,  0.0103, -3.7482],
